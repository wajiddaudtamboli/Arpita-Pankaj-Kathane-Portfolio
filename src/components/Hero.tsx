...
const PHOTO_URL = 'https://res.cloudinary.com/duhhsnbwh/image/upload/v1771498894/Arpita_zlcb1z.jpg';
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center hero-main-grid">
          ...
          <div className="order-4 lg:order-2 flex justify-center lg:justify-end mt-6 lg:mt-0">
            ...
            >
              ...
              >
                <div className="relative overflow-hidden rounded-[16px] w-[84vw] max-w-[320px] sm:w-[52vw] sm:max-w-[370px] md:w-[40vw] md:max-w-[390px] lg:w-[clamp(300px,30vw,360px)] aspect-[3/4] media-frame">
                  <img
                    src={PHOTO_URL}
